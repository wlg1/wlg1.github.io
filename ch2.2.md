...
Another way to say the value of $$n_2$$ is "preserved" is to say that we are **conditioning on** $$n_2$$. The difficulty in doing this is that each feature vector is made up of the same basis vectors (neurons), so by changing feature $$n_1$$, you are changing the basis vectors that add up to $$n_1$$, and since those basis vectors also add up to $$n_2$$, you are also changing $$n_2$$. 
