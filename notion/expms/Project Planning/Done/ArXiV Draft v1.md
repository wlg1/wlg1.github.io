...
- ✅ Find “Next Heads” by coding “next scores”
    ...
    [numseq_nextScores.ipynb](https://www.notion.so/numseq_nextScores-ipynb-2578dc5c770641f4bcb2045281d9b44a?pvs=21) 
...
- ✅ [Find more “next” heads](https://www.notion.so/numseq_nextScores-ipynb-2578dc5c770641f4bcb2045281d9b44a?pvs=21)
...
- (FIXED)⚠️ [Early head validation code](https://www.notion.so/Early-head-validation-code-be7fc9bbf047474388f55bbe8f04eb17?pvs=21)
- ⚠️ [SVD interpretable dirs](https://www.notion.so/SVD-interpretable-dirs-83533467cd334293af5913675fdeee97?pvs=21)
- TBC- [Outline Plan](https://www.notion.so/Outline-Plan-3935b02babc84c70a2be3545257d9b3e?pvs=21)
...
- Construct a circuit diagram for numseqs/months, and compare w/ greater-than circuit diagram
    - Find more causal evidence for edges BETWEEN components, not just "these are important components". Path patching between components to find these more precise interactions. [Path Patching](https://www.notion.so/Path-Patching-967be4e1a2b241418a9603911dda4561?pvs=21)
...
- ⚠️ Mean ablation numseq by repeating last. [Mean Resampling Ablation](https://www.notion.so/Mean-Resampling-Ablation-d7fd15fac3324baa96d82bada82340a1?pvs=21)
    ...
    - [Search Methods- ask ChatGPT](https://www.notion.so/Search-Methods-ask-ChatGPT-c68457cff88c4c3ba4b7fc775684496a?pvs=21)
    - Narrow circuit search to seq positions for ablation expms
    - Narrow to q, k, or v
    
- TBC- Make copy of current, then idealized draft
- ✅ [Draft search “work backwards”](https://www.notion.so/Search-Methods-brainstorm-15a3020ab00b40adb79b0acf3622f5f4?pvs=21)
...
- ⚠️ [gpt2-greater-than](https://www.notion.so/gpt2-greater-than-1d1763531c964ad28af1ee43c2253f19?pvs=21)
    - try to use rust-circuits in colab
- ✅ Turn ‘work backw’ to code. [Search Methods- brainstorm](https://www.notion.so/Search-Methods-brainstorm-15a3020ab00b40adb79b0acf3622f5f4?pvs=21)
- ✅ Automate to get edges: [Path Patching after Work Backw](https://www.notion.so/Path-Patching-after-Work-Backw-926c3d71d6304852afcc271974028aec?pvs=21)
...
- ✅- Test digits circuit on months, etc. [Months circuit](https://www.notion.so/Months-circuit-765ea1869818426298c439544a337efc?pvs=21)
- ✅- path patch on months. [Months path patch](https://www.notion.so/Months-path-patch-190601513e60424fbf7a9a8ef00a8317?pvs=21)
- ✅- decr seq circuit
...
- ✅-  [numwords_mincirc_repeatLast](https://colab.research.google.com/drive/1hEEWySgGjWxy_UWpAuT5Oh_pf4hSAvmv#scrollTo=GCCCoO0V7L7J).ipynb. [Numwords path patch](https://www.notion.so/Numwords-path-patch-324547790e19453c9c0dc07488a9b67b?pvs=21)
- ⚠️ 2, 4, 6 and other seq circuits
    
    existing: numseq_test_prompts_SMALL
    
    new: [numseq_prompts](https://colab.research.google.com/drive/1rNRrvr4qzy_zjPUK-4mJHruwFKnomrnP#scrollTo=r9_yofz3WkYm), pt2.ipynb  [Add 2 prompts](https://www.notion.so/Add-2-prompts-cfe4115b82634ce1b89a1afd0df9c9ba?pvs=21) 
...
- ✅ Move novel methods brainstorm to [Future work](https://www.notion.so/Future-work-a8d30bf9c84546da862cb2a95da71dfc?pvs=21)
...
- ✅ [How did prev papers diagnose early + mid? Try getting interpretations from prev papers that used the same heads](https://www.notion.so/Early-Head-Analysis-b73c8162b7334655ad1ff91fb236b69e?pvs=21)
- ✅ [look at attn patterns for more heads than just the top 10](https://www.notion.so/Early-Head-Analysis-b73c8162b7334655ad1ff91fb236b69e?pvs=21)

Connectivity

- 🐣 [Play around with manually sel heads for **incr digits circuit**, and check their func](https://www.notion.so/Manual-path-patch-8d30748bcf9448bf9a0b76ce78ed1dfb?pvs=21)
    - 🐣 **[iter patch from manual sel](https://www.notion.so/Early-Head-Analysis-b73c8162b7334655ad1ff91fb236b69e?pvs=21)**
...
- [✅ plan](https://www.notion.so/23-10-21-Plan-04b6844e61624b28a654df94ee7e7a40?pvs=21)
...
- ✅ back to [repeatDigits_autoAblation](https://www.notion.so/repeatDigits_autoAblation-6d3119d544f24f938eb4abe0016e9503?pvs=21)
    - ✅ run backw once ablation on repeatDigits and compare circ to IOI
    - ✅ compare to repeatLetters
- ✅ ablate by seq pos (found by attention pattern analysis) [QK ablation](https://www.notion.so/QK-ablation-f9f1b2ff2d944674a98e5b872acd5009?pvs=21). ([revisit](../Done%20b715c92198314529880806d9f206803d.md))
    ...
    - ✅ ablate by among words (for number detectors). [amongWords- QK ablation](https://www.notion.so/amongWords-QK-ablation-a6648bdac8b14573880294c84ead3474?pvs=21)
...
✅ [New Novel Contributions](https://www.notion.so/New-Novel-Contributions-7ec236f64f394e9cb03b32ca0fbf319b?pvs=21) 

✅ [Multiple Matches Algo](https://www.notion.so/Multiple-Matches-Algo-3d83df8af72c4233b51d6c60cd022f8b?pvs=21) 

- ✅ [format circ diagrams](https://www.notion.so/format-circ-diagrams-6c4906c1a09f4df399d376dee58af27b?pvs=21)
...
- [✅ brainstorm plans](https://www.notion.so/_Brainstorm-plans-chrono-a93e919e5bff4109bf54f6d3febb05c4?pvs=21)
- ✅ [Why is pure digits circuit bigger than among words](https://www.notion.so/Why-is-pure-digits-circuit-bigger-than-among-words-94916895ee7c464780702d5720045b50?pvs=21) : [hyp](https://www.notion.so/Why-is-pure-digits-circuit-bigger-than-among-words-94916895ee7c464780702d5720045b50?pvs=21)
...
- 🐣 [logit lens decr](https://www.notion.so/logit-lens-decr-80b75441653c4fed99eb1f3919e37dfb?pvs=21)
- ✅ daily [plan](https://www.notion.so/_Brainstorm-plans-chrono-a93e919e5bff4109bf54f6d3febb05c4?pvs=21)
...
- ✅ from outputted circ, rmv head one at a time to find how impt it is for circ
    - [Impt Decr Circ Heads](https://www.notion.so/Impt-Decr-Circ-Heads-109317c38d2d4bf2ba1c721d44e17d1a?pvs=21)
...
- ✅ [List Tasks](https://www.notion.so/List-Tasks-75facafe9dd445a19ab98886caaaeaea?pvs=21)
- ✅ read “circuits re-use” for how they compared diff fns of components
- ✅ [Compare incr digits subcirc to non-numericals](https://www.notion.so/Compare-incr-digits-subcirc-to-non-numericals-867b7e175ac3405db361e57d9e07710f?pvs=21)
