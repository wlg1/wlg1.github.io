...
def rename_files_and_folders(root, fn):
    """
    ...
    """
    with open(f"old_filenames_{fn}.txt", "a", encoding="utf-8") as file:
    # with open("old_filenames_{fn}.txt", "a", encoding="utf-8") as file:
        for name in os.listdir(root):
            ...
            if os.path.isfile(path):
                ...
                rename_files_and_folders(path, fn)
...
for fn in folder_names:
    ...
    if os.path.exists(f"C:\\Users\\mikel\\Downloads\\{fn}"):
        ...
        rename_files_and_folders(top_dir, fn)
