...
[^1]: The order of the projects is only ordered for the top 4, while the rest is the ordering is the submission order from latest to earliest (I observed this as I had submitted the 3rd entry, but it appears as the 1st as the other two were moved when pinned as 2nd and 3rd place)
